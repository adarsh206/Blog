...
const CategoryList = () => {
  ...
  return (
    <div className="mb-4">
            ...
            <ul>
              <li className={`px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300 ${isTagSelected("AI") ? "selected bg-indigo-300 rounded" : ""}`}>
              ...
              <li className={`px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300 ${isTagSelected("Startups") ? "selected bg-indigo-300 rounded" : ""}`}>
              ...
              <li className={`px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300 ${isTagSelected("Technology") ? "selected bg-indigo-300 rounded" : ""}`}>
              ...
              <li className={`px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300 ${isTagSelected("Apps") ? "selected bg-indigo-300 rounded" : ""}`}>
